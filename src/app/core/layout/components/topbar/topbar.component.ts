...
export class TopbarComponent {
  ...
  constructor(public navService: NavigationService, public authService: AuthenticationStateService) {
    this.isTopbarActionsEnabled$ = this.authService.isAuthenticated$;
  }
}
